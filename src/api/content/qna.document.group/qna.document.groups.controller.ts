...
import { QnaDocumentGroupsValidator } from './qna.document.groups.validator';
import { BaseController } from '../../base.controller';
import { QnaDocumentGroupsService } from '../../../database/services/contents/qna.document.groups.service';
import { ErrorHandler } from '../../../common/handlers/error.handler';
import { QnaDocumentGroupCreateModel, BadgeSearchFilters, BadgeUpdateModel, QnaDocumentGroupUpdateModel } from '../../../domain.types/content/qna.document.groups.domain.types';
import { uuid } from '../../../domain.types/miscellaneous/system.types'
import { QnaDocumentGroups } from '../../../database/models/qna.documents/qna.document.groups.model';

///////////////////////////////////////////////////////////////////////////////////////

export class QnaDocumentsGroupController extends BaseController {

    //#region member variables and constructors

    _service: QnaDocumentGroupsService = new QnaDocumentGroupsService();
